<template>
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'" label="奖励编号" prop="jianglibianhao">
					<el-input v-model="ruleForm.jianglibianhao" placeholder="奖励编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.jianglibianhao" label="奖励编号" prop="jianglibianhao">
					<el-input v-model="ruleForm.jianglibianhao" placeholder="奖励编号" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="学分" prop="xuefen">
					<el-input v-model="ruleForm.xuefen" placeholder="学分" clearable  :readonly="ro.xuefen"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="学分" prop="xuefen">
					<el-input v-model="ruleForm.xuefen" placeholder="学分" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="加学分原因" prop="jiaxuefenyuanyin">
					<el-input v-model="ruleForm.jiaxuefenyuanyin" placeholder="加学分原因" clearable  :readonly="ro.jiaxuefenyuanyin"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="加学分原因" prop="jiaxuefenyuanyin">
					<el-input v-model="ruleForm.jiaxuefenyuanyin" placeholder="加学分原因" readonly></el-input>
				</el-form-item>
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='jiaxuefenyuanyin'){
							this.ruleForm.jiaxuefenyuanyin = obj[o];
							this.ro.jiaxuefenyuanyin = true;
							continue;
						}
						if(o=='dengjishijian'){
				...
				this.ruleForm.xuefen = 0
				this.ro.xuefen = false;


				this.ruleForm.jiaxuefenyuanyin='出勤数最高'
...
var objcross = this.$storage.getObj('crossObj');
      ...
      if(objcross!=null) {
	      objcross.xuefen = parseFloat(objcross.xuefen) + parseFloat(this.ruleForm.xuefen)
                }
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `jiaxuefenjiangli/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.jiaxuefenjiangliCrossAddOrUpdateFlag = false;
						 this.parent.search();
