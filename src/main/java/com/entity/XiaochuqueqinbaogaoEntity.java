 ...
 */
@TableName("xiaochuqueqinbaogao")
public class XiaochuqueqinbaogaoEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public XiaochuqueqinbaogaoEntity() {
		
	}
	
	public XiaochuqueqinbaogaoEntity(T t) {
		try {
	 ...
	 * 设置：缺勤原因
	 */
	public void setQueqinyuanyin(String queqinyuanyin) {
		this.queqinyuanyin = queqinyuanyin;
	}
	/**
	 * 获取：缺勤原因
	 */
	public String getQueqinyuanyin() {
		return queqinyuanyin;
	}
	/**
	 * 设置：提交时间
	 */
